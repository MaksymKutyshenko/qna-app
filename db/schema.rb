...
ActiveRecord::Schema.define(version: 20161127173044) do
  ...
  create_table "subscribtions", force: :cascade do |t|
    ...
    t.datetime "created_at",        null: false
    t.datetime "updated_at",        null: false
    t.index ["subscribable_type", "subscribable_id"], name: "index_subscribtions_on_subscribable_type_and_subscribable_id", using: :btree
